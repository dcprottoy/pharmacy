...
<div class="content-wrapper">
    <x-breadcumb title="Medicine Usage"/>
    <div class="content">
        <div class="container-fluid">
            <div class="card card-info">
                <div class="card-header">
                    <h3 class="card-title">Medicine Usage</h3>
                </div>
                <form action="{{route('medicineusage.save')}}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="card-body">
                        <div class="row">
                            <div class="col-sm-4">
                                <div class="form-group">
                                    <label> Medicine Usage Name</label>
                                    <input type="text" class="form-control form-control-sm" name='name_eng' placeholder="Medicine Usage Name">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="modal-content">
                        <form action="" method="post" id="delete-modal">
                            ...
                            <div class="modal-header">
                                <h4 class="modal-title">Delete Medicine Usage</h4>
