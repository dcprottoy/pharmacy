                            ...
                            <div class="row">
                                <div class="col-sm-3">
                                    <div class="form-group">
                                        <input type="text" class="form-control form-control-sm" name='invoice_no' id="invoice_no" readonly placeholder="Invoice No">
                                    </div>
                                </div>
                                <div class="col-sm-3">
                                    <div class="form-group">
                                        <input type="text" class="form-control form-control-sm" name='supplier_name' id="customer_name" placeholder="Customer Name">
                                    </div>
                                </div>
                                <div class="col-sm-3">
                                    <div class="form-group">
