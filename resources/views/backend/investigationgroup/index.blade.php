...
<div class="content-wrapper">
    <x-breadcumb title="Investigation Group"/>
    <div class="content">
        <div class="container-fluid">
            <div class="card card-info">
                <div class="card-header">
                    <h3 class="card-title">Investigation Group Entry</h3>
                </div>
                <form action="{{route('investigationgroup.save')}}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="card-body">
                        <div class="row">
                            <div class="col-sm-4">
                                <div class="form-group">
                                    <label> Investigation Group Name</label>
                                    <input type="text" class="form-control form-control-sm" name='name_eng' placeholder="Investigation Group Name">
                                </div>
                            </div>
                            <div class="col-sm-4">
                                <div class="form-group">
                                    <label> Room No.</label>
                                    <input type="text" class="form-control form-control-sm" name='room_no' placeholder="Room No">
                                </div>
                            </div>
            ...
            <div class="card">
                ...
                <div class="m-3">
                    {{ $inv_groups->links('pagination::bootstrap-4')}}
                </div>
            </div>
                    ...
                    <div class="modal-content">
                        <form action="" method="post" id="delete-modal">
                            ...
                            <div class="modal-header">
                                <h4 class="modal-title">Delete Investigation Group</h4>
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-sm-4">
                                            <div class="form-group">
                                                <label>Investigation Group Name</label>
                                                <input type="text" class="form-control form-control-sm" id='u-name_eng' name='name_eng' placeholder="Investigation Group Name" required>
                                            </div>
                                        </div>
                                        <div class="col-sm-4">
                                            <div class="form-group">
                                                <label>Room No.</label>
                                                <input type="text" class="form-control form-control-sm" id='u-room_no' name='room_no' placeholder="Room No" required>
                                            </div>
                                        </div>
                                        <div class="form-group col-lg-4">
                                            <label>Status</label><br>
...
<script>
    $(document).ready(function(){
        $(".delete").on('click',function(e){
            ...
            let link = "{{url('investigationgroup/')}}/"+id;
        ...
        $(".update").on('click',function(e){
            let id = $(this).attr("data-id");
                $.ajax({
                    url: "{{url('investigationgroup/')}}/"+id,
                    success: function (result) {
                        console.log(result);
                        $('#u-name_eng').val(result.name_eng);
                        $('#u-room_no').val(result.room_no);
                        if(result.status == 'Y'){
