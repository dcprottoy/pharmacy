...
<div class="content-wrapper">
    <x-breadcumb title="Medicine Type"/>
    <div class="content">
        <div class="container-fluid">
            <div class="card card-info">
                ...
                <form action="{{route('medicinetype.save')}}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="card-body">
                        <div class="row">
                            <div class="col-sm-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control form-control-sm" name='name_eng' placeholder="Medicine Type Name">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="modal-content">
                        <form action="" method="post" id="delete-modal">
                            ...
                            <div class="modal-header">
                                <h4 class="modal-title">Delete Medicine Type</h4>
                ...
                <div class="modal-dialog modal-md">
                    <div class="modal-content">
                        <form action="" method="post" id="update-modal">
                            ...
                            @method('PUT')
                            <div class="modal-header">
                                <h4 class="modal-title">Update Medicine Type Information</h4>
                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                    <span aria-hidden="true">&times;</span>
                                </button>
                            </div>
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                <label>Medicine Type Name</label>
                                                <input type="text" class="form-control form-control-sm" id='u-name_eng' name='name_eng' placeholder="Medicine Type Name" required>
                                            </div>
                                        </div>
                                    </div>
                                </div>
