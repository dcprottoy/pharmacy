    ...
    <div class="content">
        <div class="container-fluid">
            <div class="card card-info">
                ...
                <form action="{{route('productcategory.save')}}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="card-body">
                        <div class="row">
                            <div class="col-sm-3">
                ...
                <div class="modal-dialog modal-xl">
                    <div class="modal-content">
                        <form action="" method="post" id="update-modal">
                            ...
                            @method('PUT')
                            <div class="modal-header">
                                <h4 class="modal-title">Update Product Category Information</h4>
                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                    <span aria-hidden="true">&times;</span>
                                </button>
                            </div>
...
<script>
    $(document).ready(function(){
        $(".delete").on('click',function(e){
            ...
            let link = "{{url('productcategory/')}}/"+id;
