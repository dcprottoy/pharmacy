...
<div class="content-wrapper">
    <x-breadcumb title="Usage"/>
    <div class="content">
        <div class="container-fluid">
            <div class="card card-info">
                <div class="card-header">
                    <h3 class="card-title">Usage Entry</h3>
                </div>
                        ...
                        <div class="row">
                            <div class="col-sm-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control form-control-sm" name='name_eng' placeholder="Usage Name">
                                </div>
                            </div>
                            <div class="col-sm-4">
                                <div class="form-group">
                                    <label>ব্যবহার নাম</label>
                                    <input type="text" class="form-control form-control-sm" name='name_bang' placeholder="ব্যবহার নাম">
                                </div>
                            </div>
            ...
            <div class="card">
                ...
                <div class="m-3">
                    {{ $usage->links('pagination::bootstrap-4')}}
                </div>
            </div>
                ...
                <div class="modal-dialog modal-xl">
                    <div class="modal-content">
                        <form action="" method="post" id="update-modal">
                            ...
                            @method('PUT')
                            <div class="modal-header">
                                <h4 class="modal-title">Update Usage Information</h4>
                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                    <span aria-hidden="true">&times;</span>
                                </button>
                            </div>
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-sm-4">
                                            <div class="form-group">
                                                <label>Usage Name</label>
                                                <input type="text" class="form-control form-control-sm" id='u-name_eng' name='name_eng' placeholder="Usage Name" required>
                                            </div>
                                        </div>
                                        <div class="col-sm-4">
                                            <div class="form-group">
                                                <label>ব্যবহার নাম</label>
                                                <input type="text" class="form-control form-control-sm" id='u-name_bang' name='name_bang' placeholder="ব্যবহার নাম" >
                                            </div>
                                        </div>
                                        <div class="form-group col-lg-4">
                                            <label>Status</label><br>
