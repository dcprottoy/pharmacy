...
<div class="content-wrapper">
    <x-breadcumb title="Medicine Category"/>
    <div class="content">
        <div class="container-fluid">
            <div class="card card-info">
                <div class="card-header">
                    <h3 class="card-title">Protuct Category</h3>
                </div>
                <form action="{{route('medicinecategory.save')}}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="card-body">
                        <div class="row">
                            <div class="col-sm-4">
                                <div class="form-group">
                                    <label> Medicine Category Name</label>
                                    <input type="text" class="form-control form-control-sm" name='name_eng' placeholder="Medicine Category Name">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="modal-content">
                        <form action="" method="post" id="delete-modal">
                            ...
                            <div class="modal-header">
                                <h4 class="modal-title">Delete Medicine Category</h4>
                ...
                <div class="modal-dialog modal-md">
                    <div class="modal-content">
                        <form action="" method="post" id="update-modal">
                            ...
                            @method('PUT')
                            <div class="modal-header">
                                <h4 class="modal-title">Update Medicine Category Information</h4>
                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                    <span aria-hidden="true">&times;</span>
                                </button>
                            </div>
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                <label>Medicine Category Name</label>
                                                <input type="text" class="form-control form-control-sm" id='u-name_eng' name='name_eng' placeholder="Medicine Category Name" required>
                                            </div>
                                        </div>
                                    </div>
                                </div>
...
<script>
    $(document).ready(function(){
        $(".delete").on('click',function(e){
            ...
            let link = "{{url('medicinecategory/')}}/"+id;
