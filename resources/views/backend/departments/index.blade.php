...
<div class="content-wrapper">
    <x-breadcumb title="Departments"/>
    <div class="content">
        <div class="container-fluid">
            <div class="card card-info">
                <div class="card-header">
                    <h3 class="card-title">Departments Entry</h3>
                </div>
                        ...
                        <div class="row">
                            <div class="col-sm-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control form-control-sm" name='name_eng' placeholder="Department Name">
                                </div>
                            </div>
                            <div class="col-sm-4">
                                <div class="form-group">
                                    <label>ডিপার্টমেন্ট নাম</label>
                                    <input type="text" class="form-control form-control-sm" name='name_bang' placeholder="ডিপার্টমেন্ট নাম">
                                </div>
                            </div>
