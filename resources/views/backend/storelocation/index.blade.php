...
<div class="content-wrapper">
    <x-breadcumb title="Store Location"/>
    <div class="content">
        <div class="container-fluid">
            <div class="card card-info">
                ...
                <form action="{{route('storelocation.save')}}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="card-body">
                        <div class="row">
                            <div class="col-sm-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control form-control-sm" name='name_eng' placeholder="Store Location Name">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="modal-content">
                        <form action="" method="post" id="delete-modal">
                            ...
                            <div class="modal-header">
                                <h4 class="modal-title">Delete Store Location</h4>
                ...
                <div class="modal-dialog modal-xl">
                    <div class="modal-content">
                        <form action="" method="post" id="update-modal">
                            ...
                            @method('PUT')
                            <div class="modal-header">
                                <h4 class="modal-title">Update Store Location Information</h4>
                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                    <span aria-hidden="true">&times;</span>
                                </button>
                            </div>
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-sm-4">
                                            <div class="form-group">
                                                <label>Store Location Name</label>
                                                <input type="text" class="form-control form-control-sm" id='u-name_eng' name='name_eng' placeholder="Store Location Name" required>
                                            </div>
                                        </div>
                                    </div>
                                </div>
