...
class MedicineTypeController extends Controller
{
    ...
    {
        $data['stores'] = MedecineType::all();
        return view('backend.medicinetype.index',$data);
    }
    ...
    {
        $lastid = MedecineType::findOrFail($id);
        return $lastid;
    }
    ...
    public function update(Request $request, string $id)
    {
        ...
        if($validated->fails()){
            ...
            $item = MedecineType::findOrFail($id);
    ...
    {
        if(MedecineType::find($id)){
            $createObject = MedecineType::find($id);
            $createObject->delete();
